...
public class HttpApiClient {
    ...
    public func sendPostBlocking(jsonRequest: String, requestUri: String, successHandler: @escaping (String) -> Void, errorHandler: @escaping () -> Void) {
        ...
        self.sendPost(jsonRequest: jsonRequest, requestUri: requestUri, successHandler: semaphoreAwareSuccessHandler, errorHandler: semaphoreAwareErrorHandler)
    ...
    public func sendPost(jsonRequest: String, requestUri: String, successHandler: @escaping (String) -> Void) {
        self.sendPost(jsonRequest: jsonRequest, requestUri: requestUri, successHandler: successHandler, errorHandler: {})
    }
    
    public func sendPost(jsonRequest: String, requestUri: String, successHandler: @escaping (String) -> Void, errorHandler: @escaping () -> Void) {
        var request = URLRequest(url: URL(string: self.trackerState.weqConfig.eventIngressHostname + requestUri)!)
